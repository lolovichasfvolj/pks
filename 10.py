...
def race(characters, laps_to_complete, lap_length):
    ...
    lines = [ax.plot([], [], marker=char.marker, markersize=10, label=char.name)[0] for char in characters]
...
def main():
    ...
    for i, (character, _) in enumerate(characters_options):
    ...
    characters = [Character(characters_options[i][0], characters_options[i][1]) for i in selected_indices]
